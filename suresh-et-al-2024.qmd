...
<center>![](figures/table01.png){width="100%"}</center>
...
- _bonafide_ training set:
    - 1265 LPVs
    - 79 non-LPVs
- ADASYN to upsample minority class
- allKNN to downsample majority class
...
<center>![](figures/figure14.png){width="100%"}</center>
